...
public enum RoleType implements BaseType {
    ...
    DEATH(Death.class, true, 0, "Your target takes people's souls. They must be Death, Horseman of the Apocalypse."),
    ...
    FAMINE(Famine.class, true, 0, "Your target starves people to death. They must be Famine, Horseman of the Apocalypse."),
    ...
    HUNGER(Hunger.class, true, 10, "Your target starves others. They must be the Hunger"),
    ...
    JAILOR(Jailor.class, true, 10, "Your target detains people at night. They must be a Jailor."),
    ...
    PESTILENCE(Pestilence.class, true, 0, "Your target reeks of disease. They must be Pestilence, Horseman of the Apocalypse."),
    ...
    RoleType(Class<?> clazz, boolean unique, int weight, String directResult) {
        this.clazz = clazz;
        this.unique = unique;
        this.weight = weight;
