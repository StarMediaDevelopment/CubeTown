...
public enum Role {
    ...
    AMNESIAC(null, "color", -1, false, NEUTRAL, BENIGN, Goal.AMNESIAC, TD, null, null), 
    ARSONIST(null, "color", -1, false, ANARCHY, KILLING, Goal.ARSONIST, TD, null, null), 
    ...
    EXECUTIONER(null, -1, false, NEUTRAL, EVIL, Goal.EXECUTIONER, TD, null, null), 
    ...
    GUARDIAN_ANGEL(null, -1, false, NEUTRAL, BENIGN, Goal.GUARDIAN_ANGEL, TD, null, null), 
    ...
    JESTER(null, -1, false, NEUTRAL, CHAOS, Goal.JESTER, TD, null, null), 
    JUGGERNAUT(null, -1, true, ANARCHY, KILLING, Goal.KILL_OPPOSE, TD, null, null), 
    ...
    PESTILENCE(null, -1, true, APOCALYPSE, KILLING, TD, null, null), 
    PIRATE(null, -1, true, NEUTRAL, KILLING, TD, null, null), 
    PLAGUEBEARER(null, -1, true, APOCALYPSE, SUPPORT, TD, null, null),
    ...
    SERIAL_KILLER(null, -1, false, ANARCHY, KILLING, TD, null, null), 
    ...
    SURVIVOR(null, -1, false, NEUTRAL, BENIGN, TD, null, null), 
    ...
    VAMPIRE(null, -1, false, MYTHICAL, CHAOS, Goal.CONVERT, TD, null, null), 
    ...
    WEREWOLF(null, -1, true, MYTHICAL, KILLING, Goal.KILL_OPPOSE, TD, null, null);
