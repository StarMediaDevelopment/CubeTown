...
public enum Role {
    ...
    POTION_MASTER(PotionMaster.class, 3, true, COVEN, EVIL, TD, null, null),
    ...
    SURVIVOR(Survivor.class, "C8C800", 3, false, NEUTRAL, BENIGN, TD, null, null),
    TRACKER(Tracker.class, 3, false, TOWN, INVESTIGATIVE, TD, null, null),
